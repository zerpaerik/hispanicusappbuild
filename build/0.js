...
var VerboRegularPage = (function () {
    function VerboRegularPage(smartAudio, plt, translateServ, alertCtrl, loadingCtrl, navCtrl, navParams, vp) {
        ...
        this.vp = vp;
        this.timeKeys = ["simple", "compuesto"];
        this.informal = true;
